...
{
    internal static class CACertInfo
    {
        public static FileInfo CAPem { get; }

        static CACertInfo()
        {
            var folderPath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile);
            var dir = $"{folderPath}{Path.DirectorySeparatorChar}.config";
            if (!Directory.Exists(dir))
                Directory.CreateDirectory(dir);

            var file = $"{dir}{Path.DirectorySeparatorChar}cacert.pem";

            CAPem = new FileInfo(file);
;        }
